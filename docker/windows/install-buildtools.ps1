...
Invoke-NativeProgram { .\visualcppbuildtools_full.exe /NoRestart /Quiet /Layout C:\build\layout }
...
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\VisualC_D14\VC_Tools.X64.Base\VC_Tools.X64.Base.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\VisualC_D14\VC_Tools.X64.Nat\VC_Tools.X64.Nat.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\VisualC_D14\VC_Tools.X64.Nat.Res\enu\VC_Tools.X64.Nat.Res.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\VisualC_D14\VC_Tools.X86.Nat\VC_Tools.X86.Nat.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\VisualCppBuildTools_Core\VisualCppBuildTools_Core.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\Win10_UniversalCRTSDK\10240\Universal CRT Headers Libraries and Sources-x86_en-us.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\Win81_SDK\Windows Software Development Kit-x86_en-us.msi" C:\build\ }
Invoke-NativeProgram { lessmsi x "C:\build\layout\packages\Win81_SDK\Windows Software Development Kit for Windows Store Apps-x86_en-us.msi" C:\build\ }
